...
import com.flickPick.databinding.FragmentFinishedBinding
...
class FinishedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentFinishedBinding = DataBindingUtil.inflate(//TODO - change
            inflater, R.layout.fragment_finished, container, false)//TODO - change
...
//                Log.i("OBSER-IntrList", filmsListViewModel.interestedList.value.toString())
                ...
                Log.i("OBSER-LIST", filmsListViewModel.finishedList.value.toString())
...
//                filmsListViewModel._interestedList.value = null
                filmsListViewModel.getFinished(it.Finished.toSet())}
...
//        })
        ...
        filmsListViewModel.finishedList.observe(viewLifecycleOwner, Observer {
            it?.let {
...
//                    R.id.action_filmsFragment_to_filmViewFragment
                    FinishedFragmentDirections.actionFinishedFragmentToFilmOrSeriesViewFragment(film)
                )
