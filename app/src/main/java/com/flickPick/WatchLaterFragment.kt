...
class WatchLaterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentWatchLaterBinding = DataBindingUtil.inflate(//TODO - change
            inflater, R.layout.fragment_watch_later, container, false)//TODO - change
...
//                Log.i("OBSER-IntrList", filmsListViewModel.interestedList.value.toString())
                ...
                Log.i("OBSER-LIST", filmsListViewModel.watchLaterList.value.toString())
...
//                filmsListViewModel._interestedList.value = null
                filmsListViewModel.getWatchLater(it.WatchLater.toSet())}
...
//        })
        ...
        filmsListViewModel.watchLaterList.observe(viewLifecycleOwner, Observer {
            it?.let {
...
//                    R.id.action_filmsFragment_to_filmViewFragment
                    WatchLaterFragmentDirections.actionWatchLaterFragmentToFilmOrSeriesViewFragment(film)
                )
