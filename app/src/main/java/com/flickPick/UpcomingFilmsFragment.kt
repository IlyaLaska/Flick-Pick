...
class UpcomingFilmsFragment : BackHandlerFragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentUpcomingFilmsBinding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_upcoming_films, container, false)
...
//        binding.filmsListViewModel = filmsListViewModel
        filmsListViewModel.getUpcomingFilms()
        ...
        binding.filmsList.addOnScrollListener(object: RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                filmsListViewModel.loadMoreIfNeeded(filmsList, "Upcoming Films")
                super.onScrolled(recyclerView, dx, dy)
            }
        })

        //TODO replace top rated with regular films
        filmsListViewModel.upcomingFilmsListNew.observe(viewLifecycleOwner, Observer {
            it?.let {
...
//                    R.id.action_filmsFragment_to_filmViewFragment
                    UpcomingFilmsFragmentDirections.actionUpcomingFilmsFragment2ToFilmViewFragment(film)
                )
            ...
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                if(query != null && query.isNotBlank()) {
                    ...
                    thisFragment.findNavController().navigate(
                        UpcomingFilmsFragmentDirections.actionUpcomingFilmsFragmentToSearchResultsListFragment(query)
                    )
                }
                return false
            }
