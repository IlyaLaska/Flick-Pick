...
import com.flickPick.databinding.FragmentPopularSeriesBinding
import com.flickPick.databinding.FragmentUpcomingFilmsBinding
import kotlinx.android.synthetic.main.fragment_top_rated.*

class PopularSeriesFragment : BackHandlerFragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentPopularSeriesBinding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_popular_series, container, false)
...
//        binding.filmsListViewModel = filmsListViewModel
        filmsListViewModel.getPopularSeries()
        ...
        binding.filmsList.addOnScrollListener(object: RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                filmsListViewModel.loadMoreIfNeeded(filmsList, "Popular Series")
                super.onScrolled(recyclerView, dx, dy)
            }
        })

        //TODO replace top rated with regular films
        filmsListViewModel.popularSeriesListNew.observe(viewLifecycleOwner, Observer {
            it?.let {
...
//                    R.id.action_filmsFragment_to_filmViewFragment
                    PopularSeriesFragmentDirections.actionPopularSeriesFragment2ToFilmViewFragment(film)
                )
            ...
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                if(query != null && query.isNotBlank()) {
                    ...
                    thisFragment.findNavController().navigate(
                        PopularSeriesFragmentDirections.actionPopularSeriesFragmentToSearchResultsListFragment(query)
                    )
                }
                return false
            }
