...
import com.flickPick.databinding.FragmentLovedBinding
...
class LovedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentLovedBinding = DataBindingUtil.inflate(//TODO - change
            inflater, R.layout.fragment_loved, container, false)//TODO - change
...
//                Log.i("OBSER-IntrList", filmsListViewModel.interestedList.value.toString())
                ...
                Log.i("OBSER-LIST", filmsListViewModel.lovedList.value.toString())
...
//                filmsListViewModel._interestedList.value = null
                filmsListViewModel.getLoved(it.Loved.toSet())}
...
//        })
        ...
        filmsListViewModel.lovedList.observe(viewLifecycleOwner, Observer {
            it?.let {
...
//                    R.id.action_filmsFragment_to_filmViewFragment
                    LovedFragmentDirections.actionLovedFragmentToFilmOrSeriesViewFragment(film)
                )
