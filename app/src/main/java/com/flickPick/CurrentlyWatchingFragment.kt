...
import com.flickPick.databinding.FragmentCurrentlyWatchingBinding
...
class CurrentlyWatchingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentCurrentlyWatchingBinding = DataBindingUtil.inflate(//TODO - change
            inflater, R.layout.fragment_currently_watching, container, false)//TODO - change
...
//                Log.i("OBSER-IntrList", filmsListViewModel.interestedList.value.toString())
                ...
                Log.i("OBSER-LIST", filmsListViewModel.currentlyWatchingList.value.toString())
...
//                filmsListViewModel._interestedList.value = null
                filmsListViewModel.getCurrentlyWatching(it.CurrentlyWatching.toSet())}
...
//        })
        ...
        filmsListViewModel.currentlyWatchingList.observe(viewLifecycleOwner, Observer {
            it?.let {
...
//                    R.id.action_filmsFragment_to_filmViewFragment
                    CurrentlyWatchingFragmentDirections.actionCurrentlyWatchingFragmentToFilmOrSeriesViewFragment(film)
                )
