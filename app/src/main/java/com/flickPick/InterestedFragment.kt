...
class InterestedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentInterestedBinding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_interested, container, false)
...
//                    R.id.action_filmsFragment_to_filmViewFragment
                    InterestedFragmentDirections.actionInterestedFragmentToFilmOrSeriesViewFragment(film)
                )
...
//        setHasOptionsMenu(true)
    ...
    override fun onDestroyView() {
        Log.i("Model:", "interestedFragment destroyed - view")
        super.onDestroyView()
    }

    override fun onDestroy() {
        Log.i("Model:", "interestedFragment destroyed ")
        super.onDestroy()
    }
}