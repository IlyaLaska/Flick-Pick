...
import com.flickPick.databinding.FragmentCurrentlyPlayingFilmsBinding
import com.flickPick.databinding.FragmentPopularFilmsBinding
import kotlinx.android.synthetic.main.fragment_top_rated.*

class CurrentlyPlayingFilmsFragment : BackHandlerFragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentCurrentlyPlayingFilmsBinding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_currently_playing_films, container, false)
...
//        binding.filmsListViewModel = filmsListViewModel
        filmsListViewModel.getNowPlayingFilms()
        ...
        binding.filmsList.addOnScrollListener(object: RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                filmsListViewModel.loadMoreIfNeeded(filmsList, "Currently Playing Films")
                super.onScrolled(recyclerView, dx, dy)
            }
        })

        //TODO replace top rated with regular films
        filmsListViewModel.nowPlayingFilmsListNew.observe(viewLifecycleOwner, Observer {
            it?.let {
...
//                    R.id.action_filmsFragment_to_filmViewFragment
                    CurrentlyPlayingFilmsFragmentDirections.actionCurrentlyPlayingFilmsFragment2ToFilmViewFragment(film)
                )
            ...
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                if(query != null && query.isNotBlank()) {
                    ...
                    thisFragment.findNavController().navigate(
                        CurrentlyPlayingFilmsFragmentDirections.actionCurrentlyPlayingFilmsFragmentToSearchResultsListFragment(query)
                    )
                }
                return false
            }
