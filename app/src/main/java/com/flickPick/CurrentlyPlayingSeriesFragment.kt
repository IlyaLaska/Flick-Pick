...
import com.flickPick.databinding.FragmentCurrentlyPlayingSeriesBinding
import com.flickPick.databinding.FragmentUpcomingFilmsBinding
import kotlinx.android.synthetic.main.fragment_top_rated.*

class CurrentlyPlayingSeriesFragment : BackHandlerFragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentCurrentlyPlayingSeriesBinding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_currently_playing_series, container, false)
...
//        binding.filmsListViewModel = filmsListViewModel
        filmsListViewModel.getNowPlayingSeries()
        ...
        binding.filmsList.addOnScrollListener(object: RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                filmsListViewModel.loadMoreIfNeeded(filmsList, "Currently Playing Series")
                super.onScrolled(recyclerView, dx, dy)
            }
        })

        //TODO replace top rated with regular films
        filmsListViewModel.nowPlayingSeriesListNew.observe(viewLifecycleOwner, Observer {
            it?.let {
...
//                    R.id.action_filmsFragment_to_filmViewFragment
                    CurrentlyPlayingSeriesFragmentDirections.actionCurrentlyPlayingSeriesFragmentToFilmViewFragment(film)
                )
            ...
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                if(query != null && query.isNotBlank()) {
                    ...
                    thisFragment.findNavController().navigate(
                        CurrentlyPlayingSeriesFragmentDirections.actionCurrentlyPlayingSeriesFragmentToSearchResultsListFragment(query)
                    )
                }
                return false
            }
